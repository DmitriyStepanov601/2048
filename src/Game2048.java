...
public class Game2048 extends JPanel {
   ...
   */
    ...
    static class Tile {
        ...
        public Color getBackground() {
            switch (value) {
                ...
                case 4096:
                    return new Color(0xC94661);
                case 8192:
                    return new Color(0xdc143c);
                case 16384:
                    return new Color(0xce2029);
                case 32768:
                    return new Color(0xa6caf0);
                case 65536:
                    return new Color(0x2487D5);
                case 131072:
                    return new Color(0x5d76cb);
            }
    ...
    public static void main(String[] args) {
        ...
        try {
            windowIcon = ImageIO.read(Game2048.class.getResource("/2048.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
